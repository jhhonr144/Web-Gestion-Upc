...
class REstudianteTest extends PHPUnit\Framework\TestCase {
    ...
    public function testRegistrarBien() {         
        $va=["","Wilfrido","0","19000301","2019-01-01","55","55"
            ,"M","2000-02-02","prueba2@unicesar.edu.co","55","55",
            "nevada","avenida","3000000000","3000000000","123"];
        $clase = new Formulario(); 
        $this->assertEquals(true, $clase->registrar1($va));
    }  
    ...
    public function testidrBien(){        
        $clase = new Formulario(); 
        $this->assertEquals("0", $clase->ConsultarId('12'));
    }
